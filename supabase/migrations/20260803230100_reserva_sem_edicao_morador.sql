-- ===========================================================================
-- Morador NAO edita reserva ja criada.
--
...
--
-- Versao migration do arquivo supabase/07_reserva_sem_edicao_morador.sql.
-- Substitui o gatilho criado em 05_reservas_seguranca.sql (aquele so
-- protegia o status). Pode rodar mesmo que o 05 ou o 07 ja tenham rodado.
-- ===========================================================================
